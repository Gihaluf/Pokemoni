	...
	public TileManager(GamePanel gp) {
		...
		public void getTileImage() {
			...
			try {
				...
				tile[0] = new Tile();
				tile[0].image = ImageIO.read(getClass().getResourceAsStream("/tile/grassss.png"));
				...
				tile[2] = new Tile();
				tile[2].image = ImageIO.read(getClass().getResourceAsStream("/tile/for.png"));
				tile[2].collision = true;
				
				tile[3] = new Tile();
				tile[3].image = ImageIO.read(getClass().getResourceAsStream("/tile/rof.png"));
				...
				tile[7] = new Tile();
				tile[7].image = ImageIO.read(getClass().getResourceAsStream("/tile/dirt.png"));
				
				tile[8] = new Tile();
				tile[8].image = ImageIO.read(getClass().getResourceAsStream("/tile/for1.png"));
